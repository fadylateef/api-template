...
public func boot(_ app: Application) throws {
    ...
    wss.get("echo") { ws, req in
        ...
        ws.onText { ws, text in
            ...
            ws.send(text: "\(series_id),1/8 Downloading ... ")
            do {
                ...
                ws.send(text: "\(series_id),2/8 Duration ...")
                ...
                ws.send(text: "\(series_id),5/8 Saving to DB ...")
